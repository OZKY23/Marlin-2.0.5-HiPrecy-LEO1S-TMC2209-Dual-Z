...
#define HOMING_FIRST_BACKOFF_MM { 10, 10}  // (mm) Move away from the endstops after homing
//#define HOMING_BACKOFF_MM { 5, 5, 5 }  // (mm) Move away from the endstops after homing
...
// @section lcd
  ...
  #define MANUAL_FEEDRATE { 80*60, 80*60, 8*60, 200 } // Feedrates for manual moves along X, Y, Z, E from panel
...
//
  ...
  #define DGUS_UPDATE_INTERVAL_MS  300    // (ms) Interval between automatic screen updates
    ...
    #define DGUS_FILAMENT_LOADUNLOAD
      ...
      #define DGUS_FILAMENT_PURGE_LENGTH 15
      #define DGUS_FILAMENT_LOAD_LENGTH_PER_TIME 1 // (mm) Adjust in proportion to DGUS_UPDATE_INTERVAL_MS
    #endif

    #define DGUS_UI_WAITING               // Show a "waiting" screen between some screens
    #if ENABLED(DGUS_UI_WAITING)
      #define DGUS_UI_WAITING_STATUS 10
      #define DGUS_UI_WAITING_STATUS_PERIOD 1 // Increase to slower waiting status looping
    #endif
  #endif
#endif // HAS_DGUS_LCD
...
#define SINGLE_Z_CALIBRATION
  ...
  #define CALIBRATION_EXTRA_HEIGHT 25
#endif
